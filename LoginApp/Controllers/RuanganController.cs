...
namespace LoginApp.API.Controllers
{
    ...
    public class RuanganController : ControllerBase
    {
        ...
        public RuanganController(IConfiguration config) => _config = config;
        ...
        public IActionResult GetDropdown()
        {
            ...
            using var cmd = new SqlCommand("SELECT Ruangan_ID, NamaRuangan FROM Ruangan", con);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    result.Add(new
                    {
                        Id = reader["Ruangan_ID"].ToString(),
                        Label = reader["NamaRuangan"].ToString()
                    });
                }
                return Ok(result);
            }
